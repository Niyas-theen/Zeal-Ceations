    ...
    <>
      ...
      <div className="pb-20">
        ...
        <div className="brand-container w-full flex items-center lg:justify-center space-x-7 lg:space-x-20  px-6 oveverflow-x-scroll scroll-smooth overflow-auto ">
          <div className="Fervoro">
            <div className="brand-1 bg-[url('./public/Fervoro.jpg')] bg-cover w-[275px] h-[400px] lg:w-[375px] lg:h-[600px] bg-[#222222] flex justify-center items-center rounded-xl">
          ...
          <div className="ardeur">
            <div className="brand-2 bg-[url('./public/Ardeur.jpg')] bg-cover w-[275px] h-[400px] lg:w-[375px] lg:h-[600px] bg-[#222222] flex justify-center items-center rounded-xl">
              {/* <h1 className="text-5xl text-[#d93827] font-Bebas ">Brand 1</h1> */}
            </div>
            <div className="brand-link w-[275px] lg:w-[375px] flex justify-between items-center p-5 font-Bebas text-5xl">
              <h1>ardeur</h1>
          ...
          <div className="revisited">
            <div className="brand-3 bg-[url('./public/Revisited.jpg')] bg-cover w-[275px] h-[400px] lg:w-[375px] lg:h-[600px] bg-[#222222] flex justify-center items-center rounded-xl">
          ...
          <div className="streetz">
            <div className="brand-4 bg-[url('./public/Streetz.jpg')] bg-cover w-[275px] h-[400px] lg:w-[375px] lg:h-[600px] bg-[#222222] flex justify-center items-center rounded-xl">
      ...
      <div className="kinttedGarments w-full flex flex-col items-center lg:flex lg:flex-row lg:justify-center lg:gap-20">
        ...
        <div className="kinttedImage pb-8">
          <div className="w-[380px] h-[500px] md:w-[700px] md:h-[500px] lg:w-[1000px] lg:h-[950px] bg-[url('./public/knittedimage.jpg')] bg-cover bg-left rounded-lg"></div>
        </div>
      </div>
      ...
      <div className="sustainableImage">
        <div className="image w-full h-[960px] bg-[url('./public/sustainablefashion.jpg')] bg-cover bg-top">
